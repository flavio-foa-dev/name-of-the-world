...
//import hero2 from "http://localhost:5173/public/img/hero2.jpg";

export default function Logar() {
  return (
  <div style={{backgroundImage: `url("http://localhost:5173/public/img/hero8.jpg ")`}} className="flex flex-1 justify-center items-center bg-cover bg-center" >
    <div className="h-screen font-sans login bg-cover flex  ">
          ...
          <form className="max-w-sm m-4 p-10 bg-white bg-opacity-30 rounded shadow-xl">
              <p className="text-white font-medium text-center text-lg font-bold">LOGIN</p>
                <div className="">
                  ...
                  <input className="w-full px-5 py-1 text-gray-700 bg-gray-300 rounded focus:outline-none focus:bg-white" type="email" id="email"  placeholder="Digite o e-mail" aria-label="email" required></input>
                </div>
                <div className="mt-2">
